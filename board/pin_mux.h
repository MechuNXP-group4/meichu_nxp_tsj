...
#define BOARD_INITPINS_SD_PWREN_PERIPHERAL                                 GPIO5   /*!< Peripheral name */
#define BOARD_INITPINS_SD_PWREN_SIGNAL                                   gpio_io   /*!< Signal name */
#define BOARD_INITPINS_SD_PWREN_CHANNEL                                       0U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_SD_PWREN_GPIO                                       GPIO5   /*!< GPIO peripheral base pointer */
#define BOARD_INITPINS_SD_PWREN_GPIO_PIN                                      0U   /*!< GPIO pin number */
#define BOARD_INITPINS_SD_PWREN_GPIO_PIN_MASK                         (1U << 0U)   /*!< GPIO pin mask */
#define BOARD_INITPINS_SD_PWREN_PORT                                       GPIO5   /*!< PORT peripheral base pointer */
#define BOARD_INITPINS_SD_PWREN_PIN                                           0U   /*!< PORT pin number */
#define BOARD_INITPINS_SD_PWREN_PIN_MASK                              (1U << 0U)   /*!< PORT pin mask */
